...
robocopy %source%\Belgyogy\Nefro\images %destination%\Belgyogy\Nefro\images /mir /max:50000000
...
robocopy %source%\done\Borgyogy\images %destination%\done\Borgyogy\images /mir /max:50000000
xcopy /y %source%\done\Borgyogy\borgyogy.html %destination%\done\Borgyogy\ /d
robocopy %source%\done\Onkologia\images %destination%\done\Onkologia\images /mir /max:50000000
xcopy /y %source%\done\Onkologia\onko.html %destination%\done\Onkologia\ /d
robocopy %source%\done\Ortopedia\images %destination%\done\Ortopedia\images /mir /max:50000000
...
xcopy /y %source%\Belgyogy\Endokrin\favicon.bmp %destination%\Belgyogy\Endokrin\ /d
robocopy %source%\done\Genetika\images %destination%\done\Genetika\images /mir /max:50000000
...
robocopy %source%\done\Immunologia\images %destination%\done\Immunologia\images /mir /max:50000000
...
robocopy %source%\done\Kortan\images %destination%\done\Kortan\images /mir /max:50000000
...
robocopy %source%\done\BioFizika\images %destination%\done\BioFizika\images /mir /max:50000000
...
robocopy %source%\done\BioKemia\I\images %destination%\done\BioKemia\I\images /mir /max:50000000
robocopy %source%\done\BioKemia\II\images %destination%\done\BioKemia\II\images /mir /max:50000000
robocopy %source%\done\BioKemia\III\images %destination%\done\BioKemia\III\images /mir /max:50000000
...
robocopy %source%\done\ANAT\images %destination%\done\ANAT\images /mir /max:50000000
xcopy /y %source%\done\ANAT\anat.html %destination%\done\ANAT\ /d
xcopy /y %source%\done\ANAT\favicon.bmp %destination%\done\ANAT\ /d
robocopy %source%\done\ANAT\Fejlodestan\images %destination%\done\ANAT\Fejlodestan\images /mir /max:50000000
...
robocopy %source%\done\ANAT\Histology\images %destination%\done\ANAT\Histology\images /mir /max:50000000
...
robocopy %source%\done\Sejtbiosz\images %destination%\done\Sejtbiosz\images /mir /max:50000000
...
robocopy %source%\done\Kemia\images %destination%\done\Kemia\images /mir /max:50000000
...
robocopy %source%\done\Biologia\images %destination%\done\Biologia\images /mir /max:50000000
...
robocopy %source%\done\FejlodesBiosz\images %destination%\done\FejlodesBiosz\images /mir /max:50000000
...
robocopy %source%\done\ModMem\images %destination%\done\ModMem\images /mir /max:50000000
