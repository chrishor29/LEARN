...
/* PROJECT - PROGRESS
 ✖: lehessen látni a kérdéseket táblázatban, melyiket hány perce repeateltem, mert felbssza maát az ember, hogy nemtudja mikor jut a végére
 ✖: MIKROBI JS:
...
megnézi, hogy az eddigi Qtext-ben van-e már: visszafele indul, a hozzá legközelebbi utolsót keresi!, ha van:
	megnézi, hogy a parentje-e, vagyis: 
		...
		ha közben áthaladt az altImpQ-n (ami elbírálás alatt) áll, akkor nem lesz importálva -> ha nem, akkor importálva lesz*/
			...
			//if (EXPid == "[19]")  { console.log(newHTML.substr(newHTML.length-3000)) }
		}
		while ( oldHTML.indexOf(' class="imp ') != -1 )
	}
	
	//console.log(document.documentElement.innerHTML.slice(document.documentElement.innerHTML.indexOf("érfogókkal ér leszorítása")))
